...
public class DashboardService {
    ...
    public DashboardSemanaResponse getResumenSemana(String discordId) {
        ...
        Integer totalFacturadoSemana = facturaRepository.sumTotalByIdEmpleadoAndFechaBetween(
                empleado.getId(),
                inicioSemana,
                finSemana
        );
